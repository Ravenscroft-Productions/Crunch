...
void UCrosshairWidget::UpdateCrosshairPosition()
{
	...
	if (TargetScreenPosition.X > 0.0f && TargetScreenPosition.X < SizeX && TargetScreenPosition.Y > 0.0f && TargetScreenPosition.Y < SizeY)
	{
...
void UCrosshairWidget::TargetUpdated(const FGameplayEventData* EventData)
{
	...
	CrosshairImage->SetColorAndOpacity(AimTarget ? HasTargetColour : NoTargetColour);		
}
